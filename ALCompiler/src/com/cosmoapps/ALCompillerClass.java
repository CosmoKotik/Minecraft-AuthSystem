...
public class ALCompillerClass {
    public static void main(String[] args) throws IOException {
        ...
        fileContents.set(17, "    private static final URL JOIN_URL = HttpAuthenticationService.constantURL(\"http://" + ipAddr + "/game/joinserver.jsp\");");
        fileContents.set(18, "    private static final URL CHECK_URL = HttpAuthenticationService.constantURL(\"http://" + ipAddr + "/game/checkserver.jsp\");");
        Files.write(Paths.get(filePath), fileContents);
