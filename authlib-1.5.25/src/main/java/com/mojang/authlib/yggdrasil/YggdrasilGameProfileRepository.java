...
public class YggdrasilGameProfileRepository implements GameProfileRepository {
    ...
    private static final String BASE_URL = "https://authserver.onefinity.ru/api/";

    private static final String SEARCH_PAGE_URL = "https://authserver.onefinity.ru/api/profiles/";
    ...
    public void findProfilesByNames(String[] names, Agent agent, ProfileLookupCallback callback) {
        ...
        label48: for (List<String> request : (Iterable<List<String>>)Iterables.partition(criteria, 2)) {
            ...
            while (true) {
                ...
                try {
                    ProfileSearchResultsResponse response = this.authenticationService.<ProfileSearchResultsResponse>makeRequest(HttpAuthenticationService.constantURL("https://authserver.onefinity.ru/api/profiles/" + agent.getName().toLowerCase()), request, ProfileSearchResultsResponse.class);
                    failCount = 0;
