...
:AuthLib recompiller
jdk1.8.0_342\bin\java -jar ALCompiler.jar src\main\java %AuthServerIP% %EnablePHPExtension% %HasAUTHSERVERsubdomain% %IsHHTPS%
...
jdk1.8.0_342\bin\jar cvfM out\authlib-1.5.25.jar -C build\classes\java\main .
